...
5. **Research Loop First**: Before issuing any diagnostic, execute the `research-loop.md` protocol to gather evidence from existing files.
...
- Ignoring the `architectural-design.md` rules. Fixes must align with the existing architecture.
