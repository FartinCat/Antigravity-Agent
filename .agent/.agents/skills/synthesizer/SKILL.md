...
- **Conflict Resolution**: Use `architectural-design.md` principles and the current repo state as the tiebreaker when plans contradict each other. Never pick a side arbitrarily — justify the ruling.
