...
1. **Self-Scan**: Read `.agent/mcps/README.md` and `.agent/antigravity-agent-install-state.json`.
...
4. **Categorize**: Map tools to Antigravity Skill Categories (System, Memory, Web, Logic).
...
7. **Log**: Append a session entry to `.agent/session-context.md` with the tool count and ecosystem health score.
