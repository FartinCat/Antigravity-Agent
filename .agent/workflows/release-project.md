---
description: "The ultimate finalizer. Cleans dump folders, evaluates market value, generates licenses, and builds the perfect README."
---
...
5. **Version Bump**: Invoke `semantic-versioning` to bump the Major version to `v1.0.0` (The first zero changes to a one).
