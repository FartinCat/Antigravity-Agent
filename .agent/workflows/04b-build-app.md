---
description: "Step 4B — Build a software application (Python/Rust/JS): Scaffold → Plan → TDD → Bug Check → Refactor → Version → Validate."
order: 5
---
...
2. **Plan**: Invoke `/planner` to map out the application architecture using `02-architectural-design.md` principles. Planner must complete the Research Loop before outputting the roadmap.
...
5. **Refactor**: Apply `04-refactor.md` principles to all generated code before committing.
